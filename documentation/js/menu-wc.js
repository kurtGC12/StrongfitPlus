...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">strongfit-plus documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/InicioClienteComponent.html" data-type="entity-link" >InicioClienteComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/PlanesComponent.html" data-type="entity-link" >PlanesComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/Publico.html" data-type="entity-link" >Publico</a>
                            </li>
                            <li class="link">
